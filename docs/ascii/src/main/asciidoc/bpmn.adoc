...
[source,java]
----
include::{exampleBase}/brainslug/SimpleExamples.java[tags=simple, indent=0]
----
...
[source,java]
----
include::{exampleBase}/brainslug/example/bpmn/BpmnExamples.java[tags=renderer-example, indent=0]
----
...
[source,java]
----
include::{exampleBase}/brainslug/example/bpmn/BpmnExamples.java[tags=transformer-example, indent=0]
----
...
[source, xml]
----
include::{exampleBase}/brainslug/example/bpmn/simple_flow.bpmn.xml[]
----
